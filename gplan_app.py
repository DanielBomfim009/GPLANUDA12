...
def main():
    ...
    programacao_page = st.Page(
        lambda: _sob_carga("Conferindo o que pode ser montado",
                           lambda: render_programacao(cache_key)),
        title="Programação", icon=":material/event_available:", url_path="programacao")
    ...
    if pode("programar"):
        administracao.append(programacao_page)
